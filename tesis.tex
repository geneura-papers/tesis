...
%
% Copyright (C) 2007 AndrÔøΩ Miede http://www.miede.de
%
...
% Elimina todas estas cosas que estÈn comentadas, no hacen m·s que
% estorbar - JJ 
...
% Hyphenation
%*******************************************************
%\hyphenation{Mul-ti-pli-ca-ti-ve de-sa-rro-llar he-te-ro-gÔøΩ-ne-os pro-pues-ta o-fi-ci-na vi-de-o-ga-mes zoo-kee-per sub-po-pu-la-tion pa-ra-digm Sprin-ger Mi-guel Mo-ra ha-bi-ta-ciÔøΩn I-lle-ras Ge-ne-bot pre-sents Ba-ye-sian al-go-rithms E-C-F re-pla-cer re-pla-cer-Na-me He-Ha OS-Gi OS-Gi-Liath W-S-D-L pro-vi-der M-M-D-P}


%********************************************************************
% Redefinir en espaÔøΩol la ediciÔøΩn en la bibliografÔøΩa
%*******************************************************
...
%********************************************************************
% Renombrar al espaÔøΩol algunos identificadores
%*******************************************************

%\renewcommand{\contentsname}{Lista de Contenidos}
%\renewcommand{\listfigurename}{Lista de Figuras}
%\renewcommand{\listtablename}{Lista de Tablas}
%\renewcommand{\bibname}{BibliografÔøΩa}
...
\newcommand{\cronbach}{\mbox{$\alpha$--\emph{Cronbach}}\xspace} % øEsto te sirve para algo? - JJ 
...
% ParÔøΩmetros para Lettrine (lo de la primera letra mÔøΩs grande en los comienzos de los capÔøΩtulos)
%
...
% AquÌ quedan todavÌa cosas rarunas - JJ
}
{
%-----------------------------  PONER LETTRINE EN SECCIONES Y NO INDENT EN SUBSECCIONES!!!
\myPart{Introducci\'on}\label{part:introduccion}
...
% Los objetivos deberÌan ir antes de todo lo dem·s. La introducciÛn,
...
%-- Art√≠culos comentados para realizar la compilaci√≥n m√°s r√°pido
