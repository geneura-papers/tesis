...
% \includepdf[pages={-},scale=1.0,pagecommand={},offset=-0.5cm -0.5cm,
%  addtolist={1, table, {Open classroom: enhancing student achievement on AI through an international online computation }, tab:cosmobot}]{pdf/jcal12075.pdf}
% \includepdf[pages={-},scale=1.0,pagecommand={},offset=-0.5cm -0.5cm,
%  addtolist={1, table, {Evolving the Strategies of Agents for the ANTS Game}, tab:iwann}]{pdf/ants_iwann2013.pdf}
